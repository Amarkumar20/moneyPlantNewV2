...
<html lang="en">
  <head>
    ...
    <title>Individual Developments | Money-plant</title>
                ...
                <div class="col-6">
                  <div class="filterBtn" onclick="toggleDiv()">
                    <div class="UpdateBtn">
                      <div class="GetStartEdBtn">
                        <p
                          class="btn btn-customClorTWo2 mb-0 d-flex align-items-center"
                          id="button1"
            ...
            <div class="card mb-3">
              <div class="row g-0">
                <div class="col-md-6">
                  <!-- Swiper -->
                  <div
                    class="swiper mySwiperOne"
                    style="padding: 0px !important"
                  >
                    <div class="swiper-wrapper">
                      <div class="swiper-slide ProductSideOne">
                        <img
                          src="https://imagedelivery.net/yg9mV_kJZn9RkpQKfOuKfA/b3437e53-ee29-45c6-9bdf-2a093190ee00/public"
                          class="img-fluid"
                          alt="SliderProduct"
                        />
                      </div>
                      ...
                      <div class="ExcusiveBtn">
                        <a
                          ...
                          >
                            ...
                            />
                            <path
                              d="M12.5 2L11 5.5L8 1.5"
                              stroke="#1f663a"
                              stroke-linecap="round"
                              stroke-linejoin="round"
                            />
                            <path
                              d="M3.5 2L5 5.5L8 1.5"
                              stroke="#1f663a"
                              stroke-linecap="round"
                              stroke-linejoin="round"
                            />
                    ...
                    <div class="mt-5">
                      <ul class="PropertiesListing_dtl">
                        ...
                        <li>
                          ...
                          ><span class="ms-4"> Meadows 2, Meadows, Dubai</span>
                        </li>
                        <li>
                        ...
                        <li>
                          <strong>Size:</strong
                          ><span class="ms-5 px-4"> 3970 sqft</span>
                        </li>
                      </ul>
                    </div>
                    <div class="mt-5">
