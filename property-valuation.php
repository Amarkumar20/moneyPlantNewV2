...
<html lang="en">
  <head>
    ...
    <title>Property Valuation | Money-plant</title>
  ...
  <body>
    ...
    <section class="property-section mb-0">
      <div class="container">
        <div class="row">
          <div class="col-lg-6 col-sm-12">
            <div class="customWidthModalDialog bg-white p-5 mb-5">
              <div class="">
                <div class="">
                  <h3 class="mb-1">Property Valuation in Dubai</h3>
                </div>
                <div class="">
          ...
          <div class="col-lg-6 col-sm-12 mt-5 mb-5">
            <section class="container px-lg-5 text-white">
              <div class="p-5">
                <h3>Property Valuation in Dubai</h3>
                <p>
                  Use the form below to contact us — we’re waiting to help you
                  sell your property.
                </p>
              </div>
    ...
    <section class="google-reviews">
      <div class="row g-0">
        <div class="google-reviews-sub1 col-lg-6 col-sm-12 ">
          <img
            style="width: 100%; height: 100%;"
            src="https://imagedelivery.net/yg9mV_kJZn9RkpQKfOuKfA/88e6b2a6-535c-4a96-3416-11f8f81e6c00/public"
            alt=""
          />
        </div>
          ...
          <div class="p-4">
            <span style="font-size: 22px"
              ><img
                ...
                src="https://imagedelivery.net/yg9mV_kJZn9RkpQKfOuKfA/3cfc9a57-cca2-4122-58be-f685c4b18800/public"
                alt=""
              />
              Reviews</span
            >
            ...
            <div class="startIconBox d-inline-flex justify-content-lg-between">
              <i class="bi bi-star-fill me-lg-2 me-sm-1"></i>
