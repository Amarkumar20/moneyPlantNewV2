...
<body>
                                    ...
                                    <div class="UpdateBtn">
                                        <div class="GetStartEdBtn">
                                            ...
                                            <p class="btn btn-customClorTWo2 mb-0 d-flex align-items-center"
                                                id="button1" onclick="toggleButton(1)">
    ...
    <section class="PropertySearch">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="PropertySearchHeading">Searching for A Nice Place to Live in? Choose Your Property Here
                    </h2>
                </div>
            </div>
            <div class="row mt-3">
            ...
            <div class="row mt-3">
                <div class="col-12">
                    <p class="ParaTwo2">MoneyPlant can change the direction of your life by a simple choice. Are you
                        anxious or panicky about searching for property yourself? Don't worry we can manage and handle
                        all your property needs.</p>
                </div>
            </div>
                                ...
                                <div class="card-body">
                                    <div class="productContact">
                                        <div class="productAlpaHeading">
                                            <h5 class=""> <a href="#" target="_blank" rel="noopener noreferrer"> 5
                                                    Bedroom Villa For Sale</a></h5>
                                        </div>
                                            ...
                                            <a href="http://" target="_blank" rel="noopener noreferrer">EXCLUSIVE
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    ...
                                                    <path d="M1.5 5.5H14.5" stroke="#1f663a" stroke-linecap="round"
                                                        stroke-linejoin="round" />
                                                    <path d="M12.5 2L11 5.5L8 1.5" stroke="#1f663a"
                                    ...
                                    <div class=" mt-5">
                                        ...
                                        <ul class="PropertiesListing_dtl">
                                            <li><strong>Price:</strong> <span class="ms-5">AED 9,950,000</span></li>
                                            <li><strong>Location:</strong><span class=" ms-4"> Meadows 2, Meadows,
                                                    Dubai</span></li>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body d-flex justify-content-center  flex-column  text-center">
                    <div class="ModalLogo">
                        <img src="https://cdn.vectorstock.com/i/preview-1x/66/14/default-avatar-photo-placeholder-profile-picture-vector-21806614.jpg"
                            alt="LogoImg" srcset="">
    ...
    <!-- Modal -->
    <div class="modal fade" id="exampleModalOne" tabindex="-1" aria-labelledby="exampleModalLabelOne"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header" style="border-bottom:0">
                ...
                <div class="modal-body">
                    <div class="contactForm">
                        <form class="" action="" method="post">
                            ...
                            <button type="submit" class="btn  mt-4 btn-customClor" style="width:100%">SEND
                                MESSAGE</button>
