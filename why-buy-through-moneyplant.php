...
<html lang="en">
  ...
  <link rel="stylesheet" href="./assests/css/why-buy-through-moneyplant.css">
  ...
  <body>
            ...
            <div class="row">
                <div class="col-lg-12 ">
                    <div class="WhyBuyHeading">
                        <h1>Your Benefit of Buying Property in<br> Dubai with MoneyPlant</h1>
                    </div>
                    <div class="WhyBuyPara">
                        ...
                        <p>We can get you where you want to be your home. Because we understand home is not just a place, it is your emotion that you want to invest in the right place.</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="ProFindBtnBox">
                        <div class="ProFindBtn">
                            <a href="http://" target="_blank" rel="noopener noreferrer">FIND A PROPERTY</a>
                        </div>

                        <div class="ProFindBtn">
                            <a href="https://mightytech.dev/clientdemo/moneyPlantNew/contact.php" target="_blank" rel="noopener noreferrer">CONTACT US</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section  class="WhyBuyBannerSection">
        <div class="container">
            <div class="WhyBuyBannerImg">
                <img src="https://imagedelivery.net/yg9mV_kJZn9RkpQKfOuKfA/c874e990-8dfd-476a-b963-d675ff81ac00/public" alt="" srcset="">
            </div>
        </div>
    ...
    <section class="contactSection">
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-12  col-md-12 paddingRight">
                    <div class="contactBox  ">
                        <div class="d-flex agent-desc">
                            <div class="circleImg">
                                <img src="https://d2fvuj1ffdxm4a.cloudfront.net/inner_pages/espace_contact_us.jpeg" alt="" srcset="">
                            </div>
                    ...
                    <div class="agent-desc">
                        <div class="whatsAppBox mt-4 " data-bs-toggle="modal" data-bs-target="#exampleModal">
                                <div class="mb-0 ">
                                    <div class="whtIcon d-flex justify-content-center  gap-2  align-items-center">
                    ...
                    <div class=" mt-5 agent-desc">
                        ...
                        <ul class="socialIconsList">
                            <li class="iconItem"><a href="http://" target="_blank" rel="noopener noreferrer"><i class="fa-brands fa-x-twitter"></i></a></li>
                            <li class="iconItem"><a href="http://" target="_blank" rel="noopener noreferrer"><i class="fa-brands fa-facebook"></i></a></li>
                            <li class="iconItem"><a href="http://" target="_blank" rel="noopener noreferrer"><i class="fa-brands fa-linkedin"></i></a></li>
                            <li class="iconItem"><a href="http://" target="_blank" rel="noopener noreferrer"><i class="fa-solid fa-link"></i></a></li>
                        </ul>
                    </div>
                    <div class="mt-4">
                        <p>Do you need a property valuation?</p>
                    </div>
                    <div class="whatsAppBox mt-4 " data-bs-toggle="modal" data-bs-target="#exampleModalOneOne">
                ...
                <div class="col-lg-8 col-md-12 col-sm-12">
                    <div class="salesText">
                        ...
                        <div class="salePara">
                            <p>We grew from a small property company to an industry. So, we have much knowledge about the places and property. Our consultant can help you make intelligent decisions about where you should invest in the property. We want you to experience quality and safety. We also deliver efficiency, which you need to make your purchase smooth and seamless.</p>
                        ...
                        <div class="salePara">
                            <p>Our strong network helps us find iconic properties in the most dynamic market that meet your specific requirements. With our award-winning agents and brokers, we guarantee to provide you with the best service and return on your investment. So, we can say confidently that you will get remarkable value and an unbeatable location with us.</p>
                        ...
                        <div class="salePara">
                             ...
                             <p><span>Buying property in Dubai</span>  is not a piece of cake. That’s why we hire the best talented, and skilled people to help you buy the right property. We want you to rely on us from day one through the handover. So, let us handle your stress, your home will be worth more than you think and add value to your investment.</p>
                        ...
                        <div class="">
                            ...
                            <p>  <a href="https://mightytech.dev/clientdemo/moneyPlantNew/contact.php" target="_blank" rel="noopener noreferrer" style="text-decoration: none; color:#000"><span>Contact Us </span> Today to Get Started</a>  </p>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-lg-12 col-xl-9">
                    ...
                    <div class="banner-content">
                        ...
                        <h2>Sell, buy, and rent your property without any hassle & make your journey smooth with us.</h2>



                          <div class="GetStartEdBtn mt-5">

                                <a  href="./about.html" class="btn btn-customClor">Meet the team</a>
        ...
        <div class="container">
            ...
            <div class="swiper mySwiper">
                ...
                <div class="swiper-slide">
                    <div class="SliderImg">
                        <img src="https://imagedelivery.net/yg9mV_kJZn9RkpQKfOuKfA/f48c843b-271b-4c65-e21a-b1717ff52200/public" alt="SliderOne" >
                    </div>
                    <div class=" mt-4 sliderFullContact">
                        <div class="SliderTextContent">
                            ...
                            <div class="">
                                <ul class="d-flex gap-4 SliderList">
                                    <li class="">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"><script xmlns="">window._wordtune_extension_installed = true;</script>
                                        <path d="M16.1999 3.59998C16.9616 3.59986 17.6948 3.88945 18.2508 4.41002C18.8068 4.93059 19.1439 5.64315 19.1939 6.40317L19.1999 6.59997V9.65997C19.8429 9.79148 20.4251 10.1301 20.8572 10.6241C21.2894 11.118 21.5478 11.74 21.5927 12.3948L21.5999 12.6V19.8C21.6002 19.9499 21.5443 20.0945 21.4433 20.2053C21.3423 20.3161 21.2034 20.3851 21.0541 20.3986C20.9048 20.4122 20.7558 20.3693 20.6365 20.2785C20.5172 20.1877 20.4362 20.0555 20.4095 19.908L20.3999 19.8V16.8H3.5999V19.8C3.60018 19.9499 3.54431 20.0945 3.44329 20.2053C3.34228 20.3161 3.20344 20.3851 3.05412 20.3986C2.90479 20.4122 2.75581 20.3693 2.6365 20.2785C2.5172 20.1877 2.43621 20.0555 2.4095 19.908L2.3999 19.8V12.6C2.39976 11.9084 2.63857 11.238 3.07592 10.7022C3.51327 10.1665 4.12228 9.79829 4.7999 9.65997V6.59997C4.79979 5.83831 5.08938 5.10512 5.60995 4.54912C6.13052 3.99312 6.84308 3.65594 7.6031 3.60598L7.7999 3.59998H16.1999ZM18.5999 10.8H5.3999C4.95263 10.8 4.52138 10.9665 4.19017 11.2671C3.85897 11.5677 3.65154 11.9808 3.6083 12.426L3.5999 12.6V15.6H20.3999V12.6C20.3999 12.1527 20.2334 11.7214 19.9328 11.3902C19.6322 11.059 19.2191 10.8516 18.7739 10.8084L18.5999 10.8ZM16.1999 4.79998H7.7999C7.35244 4.8 6.92103 4.96668 6.5898 5.26752C6.25857 5.56836 6.05126 5.98178 6.0083 6.42717L5.9999 6.59997V9.59997H7.1999V8.99997C7.1999 8.84084 7.26312 8.68823 7.37564 8.57571C7.48816 8.46319 7.64077 8.39997 7.7999 8.39997H10.7999C10.959 8.39997 11.1116 8.46319 11.2242 8.57571C11.3367 8.68823 11.3999 8.84084 11.3999 8.99997V9.59997H12.5999V8.99997C12.5999 8.84084 12.6631 8.68823 12.7756 8.57571C12.8882 8.46319 13.0408 8.39997 13.1999 8.39997H16.1999C16.359 8.39997 16.5116 8.46319 16.6242 8.57571C16.7367 8.68823 16.7999 8.84084 16.7999 8.99997V9.59997H17.9999V6.59997C17.9999 6.1527 17.8334 5.72145 17.5328 5.39025C17.2322 5.05904 16.8191 4.85161 16.3739 4.80838L16.1999 4.79998Z" fill="#1A1919"/>
                                        </svg>
                                    <span> 3 bedroom</span>
                                    ...
                                    <li class="">
                                         <svg xmlns="http://www.w3.org/2000/svg" width="22" height="23" viewBox="0 0 22 23" fill="none"><script xmlns="">window._wordtune_extension_installed = true;</script>
                                            <g clip-path="url(#clip0_1171_875)">
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M17.6685 18.6667H4.17333V5.17333H17.6666L17.6685 18.6667ZM3 5.50333V18.3367C3 19.1655 3.6745 19.84 4.50333 19.84H17.3367C18.1655 19.84 18.84 19.1655 18.84 18.3367V5.50333C18.84 4.6745 18.1655 4 17.3367 4H4.50333C3.6745 4 3 4.6745 3 5.50333Z" fill="#000" stroke="#000" stroke-width="0.5"></path>
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M13.9986 8.8402V11.5902H15.1719V7.66687H11.2486V8.8402H13.9986ZM7.83856 15.0002V12.2502H6.66522V16.1735H10.5886V15.0002H7.83856Z" fill="#000" stroke="#000" stroke-width="0.5"></path>
                                            </g>
                                            <defs>
                                            <clipPath id="clip0_1171_875">
                                            <rect width="22" height="22" fill="white" transform="matrix(-1 0 0 1 22 0.5)"></rect>
                                            </clipPath>
                                            </defs>
                                </svg>
                                        <span> 2766 sqft.</span>
                        ...
                        <div class="priceBoxOne">
                            <p class="card-price">  For Sale   <strong>AED 4,900,000</strong> </p>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body d-flex justify-content-center  flex-column  text-center">
        <div class="ModalLogo">
            <img src="https://imagedelivery.net/yg9mV_kJZn9RkpQKfOuKfA/40c5df7c-44b2-4084-8141-da2a0a97a700/public" alt="LogoImg" srcset="">
        </div>
...
<div class="modal fade" id="exampleModalOneOne" tabindex="-1" aria-labelledby="exampleModalLabelOneOne" aria-hidden="true">
  <div class="modal-dialog customWidthModalDialog">
    <div class="modal-content">
      <div class="modal-header" >
       <h5 class="modal-title modalHeader" id="exampleModalLabel">Contact MoneyPlant</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
        ...
        <div class="contactForm">
            <form class="" action="" method ="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="Email-Address" aria-describedby="NameHelp" placeholder="Your Name">
                </div>
                <div class="mb-3">
                    <label for="telephone" class="form-label">Telephone*</label>
                    <input type="text" class="form-control" id="Email-Address" aria-describedby="EmailHelp" placeholder="Phone Number">
                </div>

                 <div class="mb-3">
                    <label for="Listing-Type" class="form-label">Listing Type*</label>
                    <input type="text" class="form-control" id="Listing-Type" aria-describedby="Listing-TypeHelp" placeholder="Sell">
                </div>
                <div class="mb-3">
                    <label for="Property-location" class="form-label">Property location*</label>
                    <input type="text" class="form-control" id="Property-location" aria-describedby="Listing-Property-locationHelp" placeholder="Tower or Community">
                </div>
                ...
                <div class="mb-3 form-check">
                    ...
                    <label class="form-check-label" for="exampleCheck1">By clicking Submit, you agree to our Terms & Conditions and Privacy Policy.</label>
                </div>

                <!-- <p class="SubmitBtn">By clicking Submit, you agree to our Terms & Conditions and Privacy Policy.</p> -->
                <button type="submit" class="btn  mt-4 btn-customClor"  style="width:100%">SEND MESSAGE</button>

                <div class=" mt-5 d-flex justify-content-start  align-items-center gap-2">
                  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="90" height="36" viewBox="0 0 90 36" fill="none"><script xmlns="">window._wordtune_extension_installed = true;</script>
