...
<head>
  ...
  <title>Terminilogy | Money-plant</title>
...
<body>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="WhyBuyHeading">
            <h2 class="fs-1">
              Use this quick guide for a successful and smooth purchase plan that is given below
            </h2>
          </div>
        ...
        <div class="col-12">
          <div class="ProFindBtnBox">
            <div class="ProFindBtn">
              <a href="properties-for-sale.php" target="_blank" rel="noopener noreferrer">FIND A PROPERTY</a>
            </div>

            <div class="ProFindBtn">
              <a href="contact.php" target="_blank" rel="noopener noreferrer">CONTACT US</a>
            </div>
          </div>
        </div>
      </div>
  ...
  <section class="WhyBuyBannerSection">
    <div class="container">
      <div class="WhyBuyBannerImg">
        <img src="https://imagedelivery.net/yg9mV_kJZn9RkpQKfOuKfA/d3128d19-b3bc-4dff-52cd-9be52bd49700/public" alt=""
          srcset="" />
      </div>
    </div>
  </section>
        ...
        <div class="col-lg-4 col-md-12 col-md-12 paddingRight mt-4 mb-4">
          <div class="contactBox">
            <div class="d-flex agent-desc">
              <div class="circleImg">
                <img src="https://imagedelivery.net/yg9mV_kJZn9RkpQKfOuKfA/9ed34182-1ed4-4424-7038-a868931af500/public"
                  alt="" srcset="" />
              </div>
          ...
          <div class="mt-5 agent-desc">
            ...
            <ul class="socialIconsList">
              ...
              <li class="iconItem">
                <a href="http://" target="_blank" rel="noopener noreferrer"><i class="fa-solid fa-link"></i></a>
              </li>
            </ul>
          </div>
          <div class="mt-4">
        ...
        <div class="col-lg-8 col-md-12 col-sm-12">
          <div class="salesText mt-4">
            ...
            <div class="lisitBox">
              ...
              <p>Establish a budget, considering all relevant costs and fees, such as a 25% deposit. Pay some attention
                to the exchange rate, too, because it could fluctuate anytime if the US Federal Reserve makes any
                changes that could affect the UAE dirham's value.
              </p>
            </div>
            <div class="lisitBox">
              <i class="fa-solid fa-circle-chevron-right"></i>
              <p>Know your mortgage eligibility with an advisor who can help you understand mortgage products properly
                and provide approval procedures. This will secure your dream home for you.

              </p>
            </div>
            <div class="lisitBox">
              <i class="fa-solid fa-circle-chevron-right"></i>
              <p>Hire a skilled broker who will make you meet with the key stakeholders and support you during
                negotiations.
            ...
            <div class="lisitBox">
              <i class="fa-solid fa-circle-chevron-right"></i>
              <p>Submit your offer through your broker and ensure it is confirmed and secured by a Memorandum of
                Understanding (MOU). This critical document covers the details and terms of the purchase.

              </p>
            </div>
            <div class="lisitBox">
              <i class="fa-solid fa-circle-chevron-right"></i>
              <p>Go through the sales agreement very carefully. And make sure that you understand all points, then agree
                with all the terms and conditions that are written in the sales agreement.

              </p>
            </div>
            <div class="lisitBox">
              <i class="fa-solid fa-circle-chevron-right"></i>
              <p>To ensure the property has been paid for in full and is free of any outstanding charges or maintenance
                fees, your broker will apply for the developer's No Objection Certificate (NOC). It could take up to
                seven business days. You will receive your new title deed and be able to move into your new home once
                you have completed the transfer of property ownership and registered the sale with the Dubai Land
                Department.
        ...
        <div class="col-md-12 col-lg-12 col-xl-9">
          <div class="banner-content">
            ...
            <div class="GetStartEdBtn mt-5">
              <a href="meet-the-team.php" class="btn btn-customClor">Meet the team</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="swiper mySwiper">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <div class="SliderImg">
                <img src="https://imagedelivery.net/yg9mV_kJZn9RkpQKfOuKfA/f48c843b-271b-4c65-e21a-b1717ff52200/public"
                  alt="SliderOne" />
              </div>
  ...
  <div class="modal fade" id="exampleModalOneOne" tabindex="-1" aria-labelledby="exampleModalLabelOneOne"
    aria-hidden="true">
          ...
          <div class="contactForm">
            <form class="" action="" method="post">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="Email-Address" aria-describedby="NameHelp"
                  placeholder="Your Name" />
              </div>
              <div class="mb-3">
                <label for="telephone" class="form-label">Telephone*</label>
                <input type="text" class="form-control" id="Email-Address" aria-describedby="EmailHelp"
                  placeholder="Phone Number" />
              </div>

              <div class="mb-3">
                <label for="Listing-Type" class="form-label">Listing Type*</label>
                <input type="text" class="form-control" id="Listing-Type" aria-describedby="Listing-TypeHelp"
                  placeholder="Sell" />
              </div>
              <div class="mb-3">
                <label for="Property-location" class="form-label">Property location*</label>
                <input type="text" class="form-control" id="Property-location"
                  aria-describedby="Listing-Property-locationHelp" placeholder="Tower or Community" />
              </div>
              ...
              <div class="mb-3 form-check">
                ...
                <label class="form-check-label" for="exampleCheck1">By clicking Submit, you agree to our Terms &
                  Conditions and
                  Privacy Policy.</label>
              </div>

              <!-- <p class="SubmitBtn">By clicking Submit, you agree to our Terms & Conditions and Privacy Policy.</p> -->
              <button type="submit" class="btn mt-4 btn-customClor" style="width: 100%">
                SEND MESSAGE
              </button>
              ...
              <div class="mt-5 d-flex justify-content-start align-items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="90"
                  height="36" viewBox="0 0 90 36" fill="none">
                  <script xmlns="">
                    window._wordtune_extension_installed = true;
                  </script>
                  ...
                  <defs>
                    ...
                    <image id="image0" width="992" height="399"
