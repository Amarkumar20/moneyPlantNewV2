            ...
            <div class="row">
                <div class="col-lg-3 col-md-12 col-sm-12">
                    <div class="MeetTeamContentDetailImgG">
                        <figure>
                            <img src="https://imagedelivery.net/yg9mV_kJZn9RkpQKfOuKfA/d7bd23f0-5863-49c9-08b8-4ea9b0607800/public" class="card-img-top" alt="ImgTeam">
                ...
                <div class="col-lg-9 col-md-12 col-sm-12">
                    <div class="MeetTeamContentDetailText">
                        <div class="NameDetails mb-4">
                            <h1>Syed Mohammed Ali</h1>
                            <p class="positionPara">Sale</p>
                        </div>
