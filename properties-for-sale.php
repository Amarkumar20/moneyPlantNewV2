...
<html lang="en">
  ...
  <link rel="stylesheet" href="./assests/css/properties-for-sale.css">
  ...
  <body>
                ...
                <div class="col-lg-12 responBoxOne" >
                    ...
                    <div class="UpdateSection">
                        ...
                        <div class="AreaInput">
                            ...
                            <input type="text" class="form-control" id="" placeholder="Area or Community">
                            ...
                            <div class="filterBtn"  onclick="toggleDiv()">
                                <div class="UpdateBtn">
                                    <div class="GetStartEdBtn" >
                                       ...
                                       <p  class="btn btn-customClorTWo2 mb-0 d-flex align-items-center" id="button1" onclick="toggleButton(1)">
                            ...
                            <div class="SearchBtn">
                                <div class="UpdateBtn">
                                    <div class="GetStartEdBtn" >
                                       ...
                                       <p  class="btn btn-customClorTWo2 mb-0 d-flex align-items-center" onclick="toggleButton(2)"  id="button2" >
        ...
        <div class=" container">
            <div class="row">
                ...
                <div class="col-lg-10 col-md-12 col-sm-12 mt-3 mt-lg-0">
                     <!-- Swiper -->
                    <div class="swiper mySwiper "  style="padding: 0px !important">
                        ...
                        <a href="javascript:;" id="popular_view" class="populer_filter " >
                            ...
                            <!-- <i class="fa-solid fa-close xmark_icon"></i> -->
    ...
    <section class="PropertySearch">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="PropertySearchHeading">Searching for A Nice Place to Live in? Choose Your Property Here</h2>
                </div>
            </div>
            <div class="row mt-3">
                <div class="col-lg-5 col-md-12 col-sm-12">
                    <p class="ParaOne1">Properties for sale in Dubai - <span>984</span></p>
                        ...
                        <div class="col-lg-3 col-md-12 col-sm-12 mt-3 mt-lg-0">
                            <div class="InSoldSection">
                                <div class="form-check form-switch" style="position: relative;">
                                    ...
                                    <label class="form-check-label" for="flexSwitchCheckDefault">Include Sold </label>
                                </div>
            ...
            <div class="row mt-3">
                <div class="col-12">
                    <p class="ParaTwo2">MoneyPlant can change the direction of your life by a simple choice. Are you anxious or panicky about searching for property yourself? Don't worry we can manage and handle all your property needs.</p>
                </div>
            </div>
                    ...
                    <!-- Swiper -->
                        <div class="swiper mySwiperOne " style="padding:0px !important">
                            ...
                            <div class="swiper-slide ProductSideOne">
                                <img src="https://imagedelivery.net/yg9mV_kJZn9RkpQKfOuKfA/b3437e53-ee29-45c6-9bdf-2a093190ee00/public" class="img-fluid" alt="SliderProduct">
                            </div>
                            <div class="swiper-slide ProductSideOne">
                                <img src="https://imagedelivery.net/yg9mV_kJZn9RkpQKfOuKfA/b3437e53-ee29-45c6-9bdf-2a093190ee00/public" class="img-fluid" alt="SliderProduct">
                            </div>
                    ...
                    <div class="card-body">
                        <div class="productContact">
                            <div class="productAlpaHeading">
                                <h5 class=""> <a href="#" target="_blank" rel="noopener noreferrer"> 5 Bedroom Villa For Sale</a></h5>
                            </div>
                            <div class="ExcusiveBtn">
                                <a href="http://" target="_blank" rel="noopener noreferrer">EXCLUSIVE

                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none"><script xmlns="">window._wordtune_extension_installed = true;</script>
                                    <path d="M1.10634 5.88156L7.59853 14.3022C7.64571 14.3637 7.70641 14.4135 7.77594 14.4478C7.84546 14.4821 7.92194 14.4999 7.99947 14.4999C8.07699 14.4999 8.15347 14.4821 8.22299 14.4478C8.29252 14.4135 8.35322 14.3637 8.4004 14.3022L14.8926 5.88156C14.9564 5.79845 14.9935 5.69788 14.9988 5.59322C15.0041 5.48856 14.9774 5.38476 14.9223 5.29563L12.7201 1.74094C12.6748 1.66737 12.6114 1.60662 12.5359 1.56445C12.4605 1.52228 12.3756 1.5001 12.2892 1.5H3.70978C3.62337 1.5001 3.53841 1.52228 3.46299 1.56445C3.38757 1.60662 3.32418 1.66737 3.27884 1.74094L1.07665 5.29563C1.02155 5.38476 0.99487 5.48856 1.00017 5.59322C1.00548 5.69788 1.04251 5.79845 1.10634 5.88156V5.88156Z" stroke="#1f663a" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M1.5 5.5H14.5" stroke="#1f663a" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M12.5 2L11 5.5L8 1.5" stroke="#1f663a" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M3.5 2L5 5.5L8 1.5" stroke="#1f663a" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M8 14L5 5.5" stroke="#1f663a" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M8 14L11 5.5" stroke="#1f663a" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                                </a>
                            </div>
                        ...
                        <div class=" mt-5">
                            ...
                            <ul class="PropertiesListing_dtl"><li><strong>Price:</strong> <span class="ms-5">AED 9,950,000</span></li>
                                <li><strong>Location:</strong><span class=" ms-4"> Meadows 2, Meadows, Dubai</span></li>
                                    <li><strong>Bedrooms:</strong><span class=" ms-4">5</span></li>
                                    <li><strong>Size:</strong><span class=" ms-5 px-4"> 3970 sqft</span></li>
                            </ul>
                        </div>
                        <div class=" mt-5">
                            <ul class="ContactBox">
                                <li>
                                    <div class="whatsAppBox"  data-bs-toggle="modal" data-bs-target="#exampleModalOneOne" >
                                        <div class="mb-0 ">
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"><script xmlns="">window._wordtune_extension_installed = true;</script>
                                                <path d="M4 4H20C21.1 4 22 4.9 22 6V18C22 19.1 21.1 20 20 20H4C2.9 20 2 19.1 2 18V6C2 4.9 2.9 4 4 4Z" stroke="#1A1919" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                                <path d="M22 6L12 13L2 6" stroke="#1A1919" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                                </svg>
                                                EMAIL
                                            </div>
                                ...
                                <li>
                                    <div class="whatsAppBox" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                        <div class="mb-0 ">
                                            <div class="whtIcon d-flex justify-content-center  gap-2  align-items-center">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 32 32" fill="none"><script xmlns="">window._wordtune_extension_installed = true;</script><path d="M16.004 0h-.008C7.174 0 0 7.176 0 16c0 3.5 1.128 6.744 3.046 9.378l-1.994 5.944 6.15-1.966C9.732 31.032 12.75 32 16.004 32 24.826 32 32 24.822 32 16S24.826 0 16.004 0z" fill="#4CAF50"></path><path d="M25.314 22.594c-.386 1.09-1.918 1.994-3.14 2.258-.836.178-1.928.32-5.604-1.204-4.702-1.948-7.73-6.726-7.966-7.036-.226-.31-1.9-2.53-1.9-4.826S7.87 8.372 8.34 7.892c.386-.394 1.024-.574 1.636-.574.198 0 .376.01.536.018.47.02.706.048 1.016.79.386.93 1.326 3.226 1.438 3.462.114.236.228.556.068.866-.15.32-.282.462-.518.734-.236.272-.46.48-.696.772-.216.254-.46.526-.188.996.272.46 1.212 1.994 2.596 3.226 1.786 1.59 3.234 2.098 3.752 2.314.386.16.846.122 1.128-.178.358-.386.8-1.026 1.25-1.656.32-.452.724-.508 1.148-.348.432.15 2.718 1.28 3.188 1.514.47.236.78.348.894.546.112.198.112 1.128-.274 2.22z" fill="#FAFAFA"></path></svg>
                                                WHATSAPP
                                            </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body d-flex justify-content-center  flex-column  text-center">
        <div class="ModalLogo">
            <img src="https://cdn.vectorstock.com/i/preview-1x/66/14/default-avatar-photo-placeholder-profile-picture-vector-21806614.jpg" alt="LogoImg" srcset="">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body d-flex justify-content-center  flex-column  text-center">
        ...
        <p class="para mt-4" style="color:#1f663a;font-weight:600">+971-509683657</p>
  ...
  <div class="modal-dialog customWidthModalDialog">
    <div class="modal-content">
      <div class="modal-header" >
       <h5 class="modal-title modalHeader" id="exampleModalLabel">Book a Viewing</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
